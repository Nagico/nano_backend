...
from nano_backend.utils.storage import ImageStorage
...
class Anime(models.Model):
    ...
    cover = models.ImageField(upload_to='animes/cover', storage=ImageStorage, verbose_name='封面图片')
    cover_small = models.ImageField(upload_to='animes/cover_small', storage=ImageStorage, verbose_name='封面图片(小)')
