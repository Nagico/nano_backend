...
class Anime(models.Model):
    ...
    director = models.ForeignKey('staffs.Staff', related_name='director', on_delete=models.SET_NULL, null=True, verbose_name='导演')
    original = models.ForeignKey('staffs.Staff', related_name='original', on_delete=models.SET_NULL, null=True, verbose_name='原作')
    ...
    music = models.ForeignKey('staffs.Staff', related_name='music', on_delete=models.SET_NULL, null=True, verbose_name='音乐')
    producer = models.ForeignKey('staffs.Staff', related_name='producer', on_delete=models.SET_NULL, null=True, verbose_name='制作')
