...
class Photo(models.Model):
    ...
    anime_id = models.ForeignKey('animes.Anime', on_delete=models.CASCADE, verbose_name='动画')
    place_id = models.ForeignKey('places.Place', on_delete=models.CASCADE, verbose_name='地点')
